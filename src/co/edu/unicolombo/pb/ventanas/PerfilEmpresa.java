...
public class PerfilEmpresa extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ListaConvocatoriasEmpresa v = new ListaConvocatoriasEmpresa();
        v.setLocationRelativeTo(null);
        ...
        if (Empresa.empresas.containsKey(correo)) {
            Empresa e = Empresa.empresas.get(correo);
            List<Convocatoria> convocatorias = e.convocatorias;
            for (Convocatoria convocatoria : convocatorias) {
                model.addElement(convocatoria.toString());
            }
            if(!convocatorias.isEmpty()){
            ListaConvocatoriasEmpresa.listaConvocatoriasEmpresa.setModel(model);           
            v.setVisible(true);
            }else{
