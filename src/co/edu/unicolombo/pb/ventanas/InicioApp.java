...
public class InicioApp extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMenuItem3.setText("Elimina Cuenta");
        ...
        itemRegistrarEmpresa.setText("Registrar empresa...");
        ...
        jMenu3.setText("CONVOCATORIAS");

        jMenuItem5.setText("Agregar...");
        jMenu3.add(jMenuItem5);

        itemEditarEmpresa.setText("Editar");
        jMenu3.add(itemEditarEmpresa);

        jMenuBar1.add(jMenu3);

        jMenu4.setText("EMPLEOS");
